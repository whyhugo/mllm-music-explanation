...
# ── Dataset paths ────────────────────────────────────────────────────────────
# exp-006: augmented training set (1054 original + 2108 pitch-shifted = 3162)
#   Generated by: python qwen/augment_dataset.py
# Val set is unchanged (117 held-out clips, same as exp-005b for fair comparison)
DATA_JSON_TRAIN = os.path.join(PROJECT_ROOT, "data", "train_augmented.json")
